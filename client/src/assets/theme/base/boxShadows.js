...
/**
 * The base box-shadow styles for the SmartWaste Dashboard  Material.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire SmartWaste Dashboard  Material using thie file.
 */
